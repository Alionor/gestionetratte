...
public class TrattaDTO {
    ...
    public static Set<TrattaDTO> createTrattaDTOSetFromModelSet(Set<Tratta> tratte,
                                                                boolean includeAirbus) {
        return tratte.stream().map(tratta -> {
            TrattaDTO result = TrattaDTO.buildTrattaDTOFromModel(tratta, includeAirbus);
            return result;
